page 81293 "API_Customer"
{
    ...
    EntitySetName = 'apiCustomers';    //Make Sure First Char in Small Letter and don't use any special char or space
    EntitySetCaption = 'apiCustomers';
    PageType = API;
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                // }
                field(shippedNotInvoiced; Rec."Shipped Not Invoiced (LCY)")
                {
                    Caption = 'Amt. Rcd. Not Invoiced';
                }
                field(outstandingOrders; Rec."Outstanding Invoices (LCY)")
                {
    ...
    begin
        ...
        Rec.CalcFields("Shipped Not Invoiced (LCY)");
        ...
        if Rec."Salesperson Code" <> '' then begin
            ...
            if SalesPeople_lRec.Get(Rec."Salesperson Code") then begin
