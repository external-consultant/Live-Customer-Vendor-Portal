page 81300 "API_Vendor Age Details"
{
    // version WebPortal
    APIGroup = 'API';
    APIPublisher = 'ISPL';
    APIVersion = 'v2.0';
    Caption = 'apiVendoragedetails';
    DelayedInsert = true;
    EntityName = 'apiVendoragedetail';
    EntityCaption = 'apiVendoragedetail';
    EntitySetName = 'apiVendoragedetails';    //Make Sure First Char in Small Letter and don't use any special char or space
    EntitySetCaption = 'apiVendoragedetails';
    PageType = API;
    SourceTable = "Age Details";
    SourceTableView = where(Source = filter('Vendor Age'));
