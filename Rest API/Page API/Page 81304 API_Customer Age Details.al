page 81304 "API_Customer Age Details"
{
    // version WebPortal
    APIGroup = 'API';
    APIPublisher = 'ISPL';
    APIVersion = 'v2.0';
    Caption = 'apiCustomeragedetail';
    DelayedInsert = true;
    EntityName = 'apiCustomeragedetail';
    EntityCaption = 'apiCustomeragedetail';
    EntitySetName = 'apiCustomeragedetails';    //Make Sure First Char in Small Letter and don't use any special char or space
    EntitySetCaption = 'apiCustomeragedetails';
    PageType = API;
    SourceTable = "Age Details";
    SourceTableView = where(Source = filter('Customer Age'));
